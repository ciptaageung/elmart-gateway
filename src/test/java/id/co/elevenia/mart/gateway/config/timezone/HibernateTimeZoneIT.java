package id.co.elevenia.mart.gateway.config.timezone;

import id.co.elevenia.mart.gateway.ElmartgatewayApp;
import id.co.elevenia.mart.gateway.config.SecurityBeanOverrideConfiguration;
import id.co.elevenia.mart.gateway.repository.timezone.DateTimeWrapper;
import id.co.elevenia.mart.gateway.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, ElmartgatewayApp.class})
